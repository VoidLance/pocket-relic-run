...
export function Hud({ score, timer, isPaused, label = 'Relic shards', onPause, onResume, onRestart }: HudProps) {
  return (
    <div className="pointer-events-none absolute inset-0 z-10">
      <div className="pointer-events-auto absolute left-1/2 top-4 -translate-x-1/2 rounded-full border border-violet-300/30 bg-[#1e1633]/80 px-4 py-2 shadow-lg shadow-black/25 backdrop-blur-sm">
